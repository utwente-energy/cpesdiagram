...
% Defenition of the different nodes
 \node {Legend:}; \\
% Physical Grid Nodes
  \phynoded{p1}{}{mds:join}{mds:join}{label=above:\tiny{grid asset}}; &
  &
  \pnode{p2}{}; &
% A Device node
  \devicenoded{d1}{}{mds:electric_car}{mds:electric_car}{label=above:\tiny{device}}; &
  &
  \dnode{d2}{}; &
% A Control node
  \controlnoded{c1}{}{mds:memory}{mds:memory}{label=above:\tiny{controller}}; &
  &
  \cnode{c2}{}; &
  &
  \cnode{c3}{}; &
% A Interactive node
  \interactionnoded{i1}{}{mds:person}{mds:person}{label=above:\tiny{interaction}}; &
  &
  \inode{i2}{}; \\
};
