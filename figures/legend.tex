...
% Defenition of the different nodes
 \node {Legend:}; \\
% Physical Grid Nodes
  \phynode{p1}{mds:join}{label=above:\tiny{grid asset}}; &
  &
  \pnode{p2}{}; &
% A Device node
  \devicenode{d1}{mds:electric_car}{label=above:\tiny{device}}; &
  &
  \dnode{d2}{}; &
% A Control node
  \controlnode{c1}{mds:memory}{label=above:\tiny{controller}}; &
  &
  \cnode{c2}{}; &
  &
  \cnode{c3}{}; &
% A Interactive node
  \interactionnode{i1}{mds:person}{label=above:\tiny{interaction}}; &
  &
  \inode{i2}{}; \\
};
